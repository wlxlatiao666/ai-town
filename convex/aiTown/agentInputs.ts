    ...
    handler: (game, now, args) => {
      ...
      game.world.agents.set(
        ...
        new Agent({
          ...
          isDead: false,
          gold: description.name === 'Tycoon' ? 100 : (description.name === 'Alex' ? 20 : 0),
          wood: description.name === 'Alex' ? 20 : 10,
          food: description.name === 'Alex' ? 20 : 10,
          // Initialize last and previous trade prices to 2 by default.
          lastTrade: { woodPrice: 2, foodPrice: 2, timestamp: now },
          prevTrade: { woodPrice: 2, foodPrice: 2, timestamp: now },
          woodConsumption: 2,
          foodConsumption: 2,
          lastConsumption: now,
